...
public class AdapterNewRV extends RecyclerView.Adapter<AdapterNewRV.ItemHolder> {

    private Context context;

    private List<News> newsList;

    public AdapterNewRV(Context context, List<News> newsList) {
    ...
    public void onBindViewHolder(@NonNull ItemHolder itemHolder, int i) {
        ...
        itemHolder.title.setText(news.title);
        itemHolder.pubDate.setText(news.pubDate);
